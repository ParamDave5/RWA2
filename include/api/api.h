/**
 * @file api.h
 * @author Rutvik Kevadiya (rutvik08@umd.edu) Darshan Jain (djain12@umd.edu) Param Dave (pdave1@umd.edu)
 * @brief  his file is copied from the example downloaded from github
 *
